...
一个为 Obsidian 深度定制的功能丰富、视觉美观的日程管理插件。它将您的日程数据直接存储在本地 Markdown 文件中，确保数据的私有性与可移植性，同时提供丰富的可视化视图和数据统计功能。

---

## 🌟 核心特性

- **Markdown 驱动**：所有日程数据均以标准 Markdown 格式存储，即使不使用插件，您也能直接阅读和编辑。
...
插件会在您指定的文件夹内按月生成 Markdown 文件，格式规范且易读：
